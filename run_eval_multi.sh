...
python eval_2d_datasets.py \
  --ckpt "$CKPT" \
  --dataset_name "TNVideo" \
  --img_dir "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/VIDEO_ImageAndMask_merged/selected_images" \
  --mask_dir "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/VIDEO_ImageAndMask_merged/selected_masks" \
  --img_size 224 \
  --num_classes 2 \
  --vit_name "R50-ViT-B_16" \
  --n_skip 3 \
